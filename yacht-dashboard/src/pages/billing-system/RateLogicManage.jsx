...
export default function RateLogicManage() {
  const [data, setData] = useState([
    { id: 1, name: "尖峰時段電價", formula: "基價 × 1.5", status: "啟用" },
    { id: 2, name: "夜間折扣水價", formula: "基價 × 0.8", status: "啟用" },
    { id: 3, name: "假日泊船費", formula: "基價 × 2", status: "停用" },
  ]);
  ...
  const addItem = () => {
    Swal.fire({
      ...
      html: `
        ...
        <input id="formula" class="swal2-input" placeholder="公式">
      `,
      showCancelButton: true,
  ...
  return (
    <div className="container mt-4">
      <h3 className="mb-4 text-primary">支付計費系統 - 邏輯費率管理</h3>
